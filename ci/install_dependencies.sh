...
sudo yum -y install --skip-broken --allowerasing rpm-build \
       libcap-devel xfsprogs-devel iptables-devel \
       libmemcached-devel gtk2-devel libvirt-devel \
       libesmtp-devel nut-devel protobuf-devel jevents-devel \
       ganglia-devel mariadb-connector-c-devel qpid-proton-c-devel
