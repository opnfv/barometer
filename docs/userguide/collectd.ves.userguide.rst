...
collectd VES plugin
===================
The baromter repository contains a python based write plugin for VES.

The plugin currently supports pushing platform relavent metrics through the
...
**Domain** *"host"*
* VES domain name. It can be IP addresses or hostname of VES collector
(default: `127.0.0.1`)
