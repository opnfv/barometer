...
includes details on exposed ports and configurable enviromental variables of the base image.The
barometer-grafana image includes pre-configured source and dashboards to display statistics exposed
...
Additional dashboards can be added to barometer-grafana by mapping a volumne to /opt/grafana/dashboards.
Incase where a folder is mounted to this volumne only files included in this folder will be visible
