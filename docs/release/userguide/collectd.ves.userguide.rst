...
The VES application can be run in host mode (baremetal), hypervisor mode (within the hypervisor)
or guest mode(within a VM). The main software blocks that are required to run the VES application
demo are:
