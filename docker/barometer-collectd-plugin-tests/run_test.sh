#!/bin/bash
# Copyright 2020 Intel Corporation and OPNFV. All rights reserved.
#
...
-v $HOME/var/log/:/var/log -v /var/run:/var/run -v /tmp:/tmp -v `pwd`/plugin_test:/tests
--privileged opnfv/barometer-collectd-tests:latest

# Cleanup
sudo docker container rm $(sudo docker container ls -aq)
sudo docker rmi opnfv/barometer-collectd-tests:latest
